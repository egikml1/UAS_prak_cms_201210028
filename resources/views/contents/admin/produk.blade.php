                    ...
                    <form method="post" action="{{ route('admin.create_produk') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="url" class="form-control @error("link_instagram") is-invalid @enderror" value="{{old("link_instagram")}}" name="link_instagram" id="link_instagram" placeholder="https://instagram.com/">
