...
<html lang="en">
    <head>
        ...
        <meta content="Toko Baju Menjual berbagai macam hijab, jaket, aksesoris dan pakaian islami pria dan wanita" name="description">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        @endforeach
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ url('tentang-kami') }}">Tentang Kami</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <a href="https://www.instagram.com/alcotrabali/" class="text-terhubung"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
